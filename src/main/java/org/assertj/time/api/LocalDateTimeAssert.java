...
public class LocalDateTimeAssert extends AbstractAssert<LocalDateTimeAssert, LocalDateTime> {
  ...
  /**
   * Creates a new <code>{@link org.assertj.time.api.LocalDateTimeAssert}</code>.
   * 
   ...
   * >ISO ZonedDateTime format</a> to allow calling {@link LocalDateTime#LocalDateTime(Object) LocalDateTime(Object)}
   * constructor.
   * <p>
   * Example :
   * 
